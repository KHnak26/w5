    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor: _isDisabled ? Colors.grey.shade300 : _bgColor,
          ...
          children: iconPosition == IconPosition.left
              ? [
                  ...
                  Flexible(
                    child: Text(
                      label,
                      style: TextStyle(color: _contentColor, fontSize: 16, fontWeight: FontWeight.w600),
                      maxLines: 1,
